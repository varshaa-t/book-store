...
const ShowBook = () => {
  ...
  return (
    <div className='p-5 m-20 max-w-md mx-auto bg-slate-100 rounded-md shadow'>
      <BackButton />
      <div className='text-center'>
      <h1 className='text-2xl font-bold my-4'>{book.title}</h1>
      </div>
      {loading ? ( 
        <Spinner />
      ) : (
        <div className='flex flex-col border-2 border-sky-400 rounded-xl p-4'>
          ...
          <div className='my-4'>
            <span className='text-xl mr-4 text-gray-500'>No. of Pages: </span>
            <span className='text-xl'>{book.noOfPages}</span>
          </div>
          <div className='my-4'>
